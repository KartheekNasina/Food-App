...
<body>
<table align="left" border="2" cellpadding="30px">
<th><h2>Name</h2></th>
<th><h2>Quantity</h2></th>
<th><h2>Cost</h2></th>
<c:forEach var="item" items="${fetchitemlist}">
<tr><td><h2>${item.getName()}</h2></td>
<td><h2>${item.getQuantity()}</h2></td>
<td><h2>${item.getCost()}</h2></td></tr>
</c:forEach>
</table>
<table align="center" border="2" cellpadding="30px">
<th><h2>Name</h2></th>
<th><h2>Mobilenumber</h2></th>
<th><h2>Totalcost</h2></th>
<tr><td><h2>${foodorder.getName()}</h2></td>
<td><h2>${foodorder.getMobilenumber()}</h2></td>
<td><h2>${foodorder.getTotalcost()}</h2></td>
</tr>
</table>
</body>
</html>